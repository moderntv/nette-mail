...
class SmtpMailer implements IMailer
{
	...
	protected function connect()
	{
		...
		if ($this->secure === 'tls') {
			...
			if (!stream_socket_enable_crypto($this->connection, true, STREAM_CRYPTO_METHOD_TLSv1_0_CLIENT|STREAM_CRYPTO_METHOD_TLSv1_1_CLIENT|STREAM_CRYPTO_METHOD_TLSv1_2_CLIENT)) {
